...
> 最后更新：2026-05-23 — 完成基础模块前 5 个节点，字符串移至 STL 精讲
...
**已覆盖的设计节点：** 1.1 第一个程序 ✅ | 1.2 变量与类型 ✅ | 1.3 注释命名（合并到 1.1+1.2）✅ | 1.4 输入与运算 ✅ | 1.5 常量 ✅ | 1.6 作用域 ✅
...
| # | 模块 | 节点数 | 内容 |
|---|------|--------|------|
| 01 | 基础 | 6/12 | 52/~57 卡 | ✅ 程序结构 / 变量类型 / 注释命名 / 输入运算 / 常量 / 作用域 · ⬜ 条件分支 / 逻辑比较 / for循环 / while循环 / 数组 / 函数入门(含 static) |
