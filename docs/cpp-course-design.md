...
| 2 | 变量声明 | `variables.ts` | 11 卡 | 变量概念、基本类型、扩展整数类型、sizeof、初始化与赋值、标识符命名规则 |
...
| # | 模块 | 节点数 | 内容 |
|---|------|--------|------|
| 01 | 基础 | 5/13 | 47/~60 卡 | ✅ 程序结构 / 变量类型 / 注释命名 / 输入运算 / 常量 · ⬜ 字符串 / 作用域 / 条件分支 / 逻辑比较 / for循环 / while循环 / 数组 / 函数入门 |
