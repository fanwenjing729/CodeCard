...
export const ioNode: PathNode = {
  ...
  cards: [
    ...
    },
    {
      ...
      content: {
        title: '什么是转义字符',
        body: '有些字符无法直接在代码中打出（如换行），或者会和语法冲突（如字符串里的双引号）。这时用 \\（反斜杠）加上另一个字符来"转义"。\n\n注意区别：\n• \\ 是反斜杠（backslash），不是注释。注释是 //（正斜杠）\n• \\n 在 C++ 源码中写两个字符，但编译器把它当成一个换行符\n• 想输出字面值 \\n 才需要写成 \\\\n（两个反斜杠转义第一个反斜杠）',
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        ...
        options: ['A\\nB', 'A（换行）B', 'AB', '编译错误'],
        answer: 'A（换行）B',
        explanation: '\\n 在 C++ 字符串中是一个转义字符，表示换行。所以 A 在第一行，B 在第二行。注意：\\n 在源码中写的是两个字符（反斜杠 + n），但编译器把它当做一个换行符（1 个字符）。',
      },
    },
    {
      id: 'cpp-01-basics-io-c11',
      cardType: 'practice',
      content: {
        question: '要在屏幕上输出 C:\\Users，C++ 代码中应该怎么写？',
        questionType: 'choice',
